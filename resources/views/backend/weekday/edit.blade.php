            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-payment-inner-st">
                        ...
                        <form action="{{route('weekday.update',['weekday' => $weekday->id])}}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="name[]" required type="text" class="form-control" placeholder="Title" value="{{$weekdayTranslate[$key]->name ?? ""}}">
                                                    </div>
