                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="place_id" style="visibility: hidden" type="text" class="form-control" value="{{$place}}" placeholder="Department">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="key[]" required type="text" class="form-control" placeholder="Key">
                                                    </div>
                                                    <div class="form-group">
                                                        <textarea name="value[]" required placeholder="Value" ></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
